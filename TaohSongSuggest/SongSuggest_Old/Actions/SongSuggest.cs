...
namespace Actions
{
    public class SongSuggest
    {
        ...
        public void SuggestedSongs(SongSuggestSettings linkedSettings)
        {
            //Load Link Data
            ...
            if (linkedSettings.ignorePlayedAll)
            {
            ...
            {
                ignoreSongs.AddRange(activePlayer.GetYoungerThan(linkedSettings.ignorePlayedDays));
            }
            ...
            int playerRankFrom = linkedSettings.rankFrom;
            int playerRankTo = linkedSettings.rankTo;
            ...
            //Add Liked songs.
            if (linkedSettings.useLikedSongs) originSongsIDs = originSongsIDs.Union(songLiking.GetLikedIDs()).ToList();

            //Fill list to 50 if liked songs are not used, or the selection is made to fill
            if (!linkedSettings.useLikedSongs || linkedSettings.fillLikedSongs) originSongsIDs = originSongsIDs.Union(activePlayer.GetTop(50-originSongsIDs.Count())).ToList();
            ...
            //originSongsIDs = new List<String> { "371242", "335370", "347471", "373245", "347062", "347383", "304261", "277080", "340407", "354623", "362925", "314317", "323577", "301227", "324687" };
            ...
            suggestedSongs.SetRelevance(this, originSongs.endPoints.Count(), linkedSettings.styleFocus);
            Console.WriteLine("Completion: " + (songSuggestCompletion * 100) + "%");
